      ...
      <div>
        <div class="flex justify-center">
          <div class="flex flex-1 gap-3 max-w-[480px] flex-col items-stretch px-4 py-3">
            ...
            <p class="text-xs text-center text-slate-500 mt-1">This button will be enabled soon!</p>
            <button
        ...
        triggerAiCallBtn.addEventListener('click', async () => {
            ...
            try {
                ...
                const response = await fetch(TRIGGER_AI_CALLS_URL, {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({ manualTrigger: true, jobId: jobId, warranty: warrantyName })
                });
...
async function generatePDF(invoiceDataForPdf, isPreview = false) {
    ...
    try {
        ...
        const logoBase64Data = "data:image/png;base64,"; 
        if (logoBase64Data) {
            try {
                // The logo's vertical position is set to -25 as requested.
                doc.addImage(logoBase64Data, 'PNG', margin, -10, 50, 0); 
                yPos += 15;
            } catch (e) {
